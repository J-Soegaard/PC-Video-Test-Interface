...
<body>
    ...
    <div class="container">
        <br>
            <div class="col-md-4">
                <font color="white" class="h1">Video A, Pair <?php echo $next ?>/9</font>
            </div>
            ...
            <div class="btn-group btn-group-lg col-md-7">
                ...
                <button type="button" class="btn btn-primary" id="next" style="width:150px;height:50px;visibility:hidden">Next Video</button>
            </div> 
            <div class="col-md-1">
            ...
            $('#next').on('click', function() {
                if ($(this).attr('visibility') === 'hidden') {
                    ...
                    $.ajax({
                        ...
                        data: {id: "<?php echo $id ?>", vid: "1", time: vidtime},
                        success: function() {
                            window.location.href = "test2.php?id=<?php echo $id ?>";
                        }
                    });
